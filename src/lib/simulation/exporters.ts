...
export function exportSessionJson(session: ArenaSession): string {
  return JSON.stringify(session, null, 2);
}

export function exportSessionsJson(sessions: ArenaSession[]): string {
  return JSON.stringify(sessions, null, 2);
}

export function exportSessionCsv(session: ArenaSession): string {
  const header = [
    'gameId',
    'stepNumber',
    'scenario',
...
export function exportSessionsCsv(sessions: ArenaSession[]): string {
  const header = [
    'gameId',
    'timestamp',
    'scenario',
...
export function exportSessionShareGptJsonl(session: ArenaSession): string {
  const obj = {
    id: session.gameId,
...
export function exportSessionsShareGptJsonl(sessions: ArenaSession[]): string {

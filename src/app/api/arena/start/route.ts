...
import { assertApiAccess, assertSameOrigin, assertStartRateLimit, AccessError } from '@/lib/simulation/request-security';
import { enqueueRun } from '@/lib/simulation/runtime';
import { runSimulation } from '@/lib/simulation/runner';
import { DIFFICULTY_STEP_LIMIT, getScenario, getTaskForDifficulty } from '@/lib/simulation/scenarios';
import { saveSession } from '@/lib/simulation/store';
import type { ArenaSession, StartSimulationRequest } from '@/lib/simulation/types';
import { validateTargetUrl, UnsafeTargetError } from '@/lib/simulation/target-security';
import { parseStartRequest, ValidationError } from '@/lib/simulation/validation';

...
import type { ArenaSession, TaskAgentStep } from '@/lib/run-engine/types';
      ...
      <section className="card mb-4 p-4 fade-in">
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            <Link href="/api/run-control/collections?format=json" className="chip chip-accent">
              Export JSON
            </Link>
            <Link href="/api/run-control/collections?format=csv" className="chip chip-accent">
              Export CSV
            </Link>
            <Link href="/api/run-control/collections?format=sharegpt" className="chip chip-accent">
